                                                    ...
                                                    <form id="add" class="rounded-form" method="post" >
                                                       ...
                                                       <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Enter Location" required maxlength="25">
                                                          </div>
                                                         <div class="col-md-6">
                                                         <label for="contact-person" class="form-label text-primary">Location Arabic:</label>
                                                              <input type="text" class="form-control" id="titlear" name="titlear" placeholder="Enter Location Arabic" required maxlength="25">
                                                          </div>
                                                      </div>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       ...
       var titlear=$('#titlear').val();
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addlocationprocess';?>", // point to server-side controller method
