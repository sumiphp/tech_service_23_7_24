			...
			<div class="container">
              <div class="dashboard-bgarea">
                ...
                <div class="dashboard-innerbox">
                            ...
                            <div class="col-md-12"><div class="inner-card">
                                                          <div class="row">
                                                      ...
                                                      <div class="mb-3">
                                                          ...
                                                          <textarea class="form-control" id="metatag1" name="metatag1" rows="20" placeholder="Enter Meta Tag2"><?php echo $result->metatag2;?></textarea>
                                                      </div>
