                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="addcarousal" class="rounded-form" method="post" >
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="company-name" class="form-label text-primary">Title1 English:</label>
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title1 English" required maxlength="300">
                                          
                                                          </div>
                                                          <div class="col-md-6">
                                                          <label for="company-name" class="form-label text-primary">Title1 Arabic:</label>
                                                              <input type="text" class="form-control" id="titlear" name="titlear" placeholder="Enter Title1 Arabic" required maxlength="300">
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title2ar" name="title2ar" placeholder="Enter Title2 Arabic" required maxlength="300">
                                                          </div>
                                                      ...
                                                      <div class="row mb-3">
                                                                                                                   ...
                                                                                                                   <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">Title3 English:</label>
                                                              <input type="text" class="form-control" id="title3" name="title3" placeholder="Enter Title3"  maxlength="300">
                                                          </div>
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="title3ar" name="title3ar" placeholder="Enter Title3 Arabic"  maxlength="300">
                                                          </div>
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">Title4 English:</label>
                                                              <input type="text" class="form-control" id="title4" name="title4" placeholder="Enter Title4"  maxlength="300">
                                                          </div>
                                                          <div class="col-md-6">
                                                          <label for="contact-person" class="form-label text-primary">Title4 Arabic:</label>
                                                              <input type="text" class="form-control" id="title4ar" name="title4ar" placeholder="Enter Title4 Arabic"  maxlength="300">
                                                          </div>
                                                      </div>
