                                                ...
                                                <div class="product-info">
                                                    <form id="menufrm" class="rounded-form" method="post"  action="<?php echo base_url().'Welcome/editmenuprocess';?>" enctype='multipart/form-data' >
                                                      <div class="row mb-3">
                                                          ...
                                                          <label for="company-name" class="form-label text-primary">Menu Name Arabic:</label>
                                                              <input type="text" class="form-control" id="menunamear" name="menunamear" placeholder="Enter Menu Name Arabic" maxlength="50" required value="<?php echo $result->menunamear;?>">
...
$('#menufrm1').on('submit', function (e) {
   ...
   //alert("enter");
        ...
        form_data.append('menunamear',menunamear);
