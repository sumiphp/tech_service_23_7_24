                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <?php }?>
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter Description English1" required maxlength="170"></textarea>
                                                          </div>

                                                          <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Enter Description Arabic1:</label>
                                                          <textarea class="form-control" id="descriptionar" name="descriptionar" rows="3" placeholder="Enter Description Arabic1" required maxlength="170"></textarea>
                                                          </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <textarea class="form-control" id="description2" name="description2" rows="3" placeholder="Enter Description English2" required maxlength="170"></textarea>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Enter Description Arabic2:</label>
                                                          <textarea class="form-control" id="descriptionar2" name="descriptionar2" rows="3" placeholder="Enter Description Arabic2" required maxlength="170"></textarea>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <textarea class="form-control" id="description3" name="description3" rows="3" placeholder="Enter Description English3" required maxlength="170"></textarea>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Enter Description Arabic3:</label>
                                                          <textarea class="form-control" id="descriptionar3" name="descriptionar3" rows="3" placeholder="Enter Description Arabic3" required maxlength="170"></textarea>
                                                      </div>
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <textarea class="form-control" id="description4" name="description4" rows="3" placeholder="Enter Description English4" required maxlength="170"></textarea>
                                                      </div>

                                                      <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Enter Description Arabic4:</label>
                                                          <textarea class="form-control" id="descriptionar4" name="descriptionar4" rows="3" placeholder="Enter Description Arabic4" required maxlength="170"><?php echo $result->contentid;?></textarea>
                                                      </div>
                                                      <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $result->contentid;?>" placeholder="Enter Menu Name" required>
