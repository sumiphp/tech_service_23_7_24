                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <tr role="row" class="odd" id="<?php //echo $res['newsletterid'];?>" >
                                                      <td class="sorting_1"><a href="<?php echo base_url().'sitemap/index';?>" target=_blank>Click here to view sitemap</a></td>
                                                ...
                                                <thead>
                                                    <tr role="row" class="odd">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Upload Robots.txt </th>
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr role="row" class="odd"> <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">
                                                    <input type="file" class="form-control" id="image1" name="image1" style="width:50%">  <input type="Submit" class="form-control btn btn-primary" Value="Go"  style="width:30%" />
                                                    </th><th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">
