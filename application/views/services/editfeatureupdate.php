                                                    ...
                                                    <form id="edit" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <img src="<?php echo base_url().'uploads/featureicon/'.$result->featureicon;?>" width="50" height="50" />
                                                              <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $result->featureid;?>" placeholder="Enter Menu Name" required>
                                                          </div>
                                                      </div>
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
...
$('#edit').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/editfupprocess';?>", // point to server-side controller method
        ...
        $(this).val('');
                ...
                window.location.href ="<?php echo base_url().'Welcome/listfeatureupdate';?>";
