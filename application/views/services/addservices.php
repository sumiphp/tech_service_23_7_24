                                            ...
                                            <div class="inner-card-body">
                                                <div class="product-info">
                                                    <form id="addservices" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="row mb-3">
                                                          <div class="col-md-6">
                                                              <label for="contact-person" class="form-label text-primary">Subtitleeee:</label>
                                                      ...
                                                      <div class="mb-3">
                                                      <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Description English:</label>
                                                          <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter Description English"></textarea>
                                                          </div>
                                                          <div class="col-md-6">
                                                          <label for="address" class="form-label text-primary">Description Arabic:</label>
                                                          <textarea class="form-control" id="descriptionar" name="descriptionar" rows="3" placeholder="Enter Description Arabic"></textarea>
                                                          </div>
                                                      </div>
                                                      <!---<div class="row mb-3">
                                                          <div class="col-md-6">
