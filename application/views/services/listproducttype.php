                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;"> Product Type</th>
                              
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Product Type description</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['producttypeid'];?>" >
                                                      <td class="sorting_1"><?php echo $res['producttypetitle'];?></td>
                                                      <!--<td>Indoor Lamps</td>-->
                                                      <td><?php echo $res['producttypedesc'];?></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editproducttype/'.$res['producttypeid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#"  onclick="del(<?php echo $res['producttypeid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
function del(id){
    ...
    $.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/delproducttype';?>",
            data:{id:id},
