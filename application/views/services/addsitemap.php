                                                    ...
                                                    <form id="add" class="rounded-form" method="post" >
                                                      ...
                                                      <div class="row mb-3">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <input type="text" class="form-control" id="alttagimg1" name="alttagimg1" required placeholder="Enter Keyword" value="<?php //echo $result->alttagimg1;?>">
                                                          </div>
                                                      ...
                                                      <a class="btn btn-primary me-3" href="<?php echo base_url().'Welcome/listkeywords';?>" data-bs-original-title="" title="">View/Edit  </a>
...
$('#add').on('submit', function (e) {
    ...
    //alert("add");
       //var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Welcome/addsitemapprocess';?>", // point to server-side controller method
