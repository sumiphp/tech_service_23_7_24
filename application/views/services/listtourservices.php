                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">Urlkey</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['contentid'];?>" >
                                                      ...
                                                      <td class="sorting_1"><?php echo $res['title'];
                                                      
                                                     //echo $string = preg_replace('/\s+/','',$res['title']);
                                                      
                                                      ?></td>
                                                      <td><?php echo $res['urlkey'];?></td>
