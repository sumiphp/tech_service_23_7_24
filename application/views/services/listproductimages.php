...
<!-- End Sidebar Modal -->
   ...
   echo $image11=$imgdetails->itemname;
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editproductimages/'.$res['imgid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deleteproductimages';?>",
            data:{id:id},
