...
<?php }?>
    ...
    <h5><span class="line2"> <img src="<?php echo base_url().'tech/img/bg/circle_right.png';?>" alt="circle_right"></span>   <?php if (($this->uri->segment(1)=='') || ($this->uri->segment(2)=='en')){?>
                                <?php 

echo $resulthome->title8;
                                } else { echo $resulthome->title8ar; ?>   <?php } ?> <span class="line3"> <img src="<?php echo base_url().'tech/img/bg/circle_right.png';?>" alt="circle_left"></span></h5>
...
echo $resulthome->title1;
                                } else { echo $resulthome->title1ar; ?>   <?php } ?>
                       ...
                       <div class="col-lg-4 col-md-6">
                          ...
                          <div class="services-box2 mb-30">
                              <div class="services-img">
                                ...
                                <?php if (($this->uri->segment(1)=='') || ($this->uri->segment(2)=='en')){?>
                                    <h3><a href="<?php echo base_url().'Techservices/servicedetails/en/'.$res['contentid'];?>"><?php echo $res['title'];?></a></h3>   
                                    <p><?php echo $res['description1'];?></p>
                                    <?php } else {?>
                                        <h3><a href="<?php echo base_url().'Techservices/servicedetails/ar/'.$res['contentid'];?>"><?php echo $res['title1ar'];?></a></h3>   
                                    ...
                                    <?php if (($this->uri->segment(1)=='') || ($this->uri->segment(2)=='en')){?>                                         
                                        <a href="<?php echo base_url().'servicedetails/en/'.$res['contentid'];?>" class="btn ss-btn">View More</a>
                                        <?php } else { ?>
                                            <a href="<?php echo base_url().'servicedetails/ar/'.$res['contentid'];?>" class="btn ss-btn">عرض المزيد</a>
    ...
    <?php } ?>                               
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <?php if (($this->uri->segment(1)=='') || ($this->uri->segment(2)=='en')){?> 
                                                            ...
                                                            <?php } else {?>
                                                                <button class="btn ss-btn" data-animation="fadeInRight" data-delay=".8s">أرسل الآن</button>
