                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><?php echo $this->session->flashdata('flash_msg');?><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Keyword</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['productid'];?>" >
                                                   
                                                      <td class="sorting_1"><?php echo $res['loc'];?></td>
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editkeywords/'.$res['productid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['productid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletekeywords';?>",
            data:{id:id},
