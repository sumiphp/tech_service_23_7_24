...
<!-- End Sidebar Modal -->
                ...
                <div class="dashboard-innerbox">
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      ...
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 142px;">Model</th>
                                                      <th class="sorting" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 220px;">Type</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['itemid'];?>" >
                                                   
                                                      <td class="sorting_1"><?php echo $res['itemname'];?></td>
                                                      <td><?php echo $res['model'];?></td>
                                                     
                                                      <td><?php $prdtype=$res['type'];
                    ...
                    $query = $this->db->get();
                    $dt=$query->row();
                    echo $dt->producttypetitle;
                                                      
                                                      
                                                      ?></td>
                                                      <!--td><?php //echo $res['title4'];?></td>-->
                                                      <td><img src=<?php echo base_url().'uploads/item/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editproduct/'.$res['itemid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['itemid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deleteitem';?>",
            data:{id:id},
