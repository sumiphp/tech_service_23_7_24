                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                ...
                                                <?php echo $this->session->flashdata('flash_msg');?>
                                                  ...
                                                  <thead>
                                                    <tr role="row">
                                                      <th class="sorting_asc" tabindex="0" aria-controls="data-source-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 116px;">Project</th>
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['imgid'];?>" >
                                                      ...
                                                      <td class="sorting_1"><?php $ty=$res['type'];
                                                      if ($ty==1){
                                                        echo "Quality services";
                                                      }
                                                      if ($ty==0){
                                                        echo "Projects";
                                                      }
                                                      if ($ty==2){
                                                        echo "Home Page Top images";
                                                      }
                                                      ...
                                                      <td><img src=<?php echo base_url().'uploads/projects/'.$res['picture']?> width="80" height="80" /></td>
                                                      <td> <?php if ($res['active']==1){ echo "Active"; } else { echo "Inactive";}?>
                                                    </td>
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editprojects/'.$res['imgid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deleteprj';?>",
            data:{id:id},
